...
def EIA_dataset(choice:str):
    ...
    #### end edits section ####
        ...
        df['Year'] = eyear
        if eyear == '2020':
            df = df[['Year', 'ORISPL', 'PSTATABB', 'LAT', 'LON', 'PNAME', 'FIPSST', 'FIPSCNTY',  'CAPFAC', 'PLNGENAN', 'PLNOXAN', 'PLSO2AN', 'PLCO2AN', 'PLFUELCT', 'PLGENACL', 'SECTOR']]
        else:
            df = df[['Year', 'ORISPL', 'PSTATABB', 'LAT', 'LON', 'PNAME', 'FIPSST', 'FIPSCNTY',  'CAPFAC', 'PLNGENAN', 'PLNOXAN', 'PLSO2AN', 'PLCO2AN', 'PLFUELCT', 'PLGENACL']]

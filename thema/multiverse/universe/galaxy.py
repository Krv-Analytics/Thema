...
logger.addHandler(
    logging.NullHandler()
)  # suppress messages unless app enables them
...
class Galaxy:
    ...
    def __init__(
        ...
        self.outDir = outDir
        # Store YAML path for later serialization helpers
        ...
        # For static type checkers: after runtime assertions, these are non-None
